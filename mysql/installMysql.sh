...
clear
echo "========================================================================="
echo "      install MySQL 5.7.23 on CentOS 7.4+ "
echo "========================================================================="
...
#set mysql root password
    echo "==========================="
        mysqlrootpwd="$1"
        if [ "$1" = "" ]; then
                mysqlrootpwd="Mysql_p0o9i8u7y6"
        fi

#which MySQL Version do you want to install?
echo "==========================="
    isinstallmysql57="5.7.23"
    echo "Install MySQL 5.7.23,Please input y"
...
echo "============================MySQL 5.7.23 installing…………========================="

##define mysql directory configuration variable
Datadir=/usr/local/mysql/data
Binlogdir=/usr/local/mysql/binlog
Logdir=/usr/local/mysql/logs

##yum install  devel and wget mysql
yum install numactl 
##/usr/bin/wget -P /ops/inst/ http://mirrors.sohu.com/mysql/MySQL-5.7/mysql-5.7.23-linux-glibc2.12-x86_64.tar.gz
sleep 2
...
Pass=$(grep 'A temporary password' /usr/local/mysql/logs/error.log |awk  '{print $NF}')
...
echo "============================MySQL 5.7.23 install completed========================="
